...
运行时间：2026-08-29T17:40:56.5249295，端点 `https://api.deepseek.com/chat/completions`，模型 `deepseek-v4-pro`。
...
| 检索 | 查询 | 命中数 |
|---|---|---|
| 身份检索 | Creep / Radiohead | 20 |
| 身份检索 | Creepin' / Metro Boomin, The Weeknd, 21 Savage | 20 |
| 文本兜底检索 | Nobody could, I need to be around you Watching you, no one e… | 0 |
| 文本兜底检索 | I have to live without you Nobody could, I need to be around… | 0 |

songMatch：`SongMatch(status=UNCONFIRMED, title=Creep, artist=Radiohead, confidence=null, source=lyrics-candidate-unverified)`

**触发的策略：** 2 路身份检索 + 1 路文本兜底检索（放宽门控触发） 均未通过 DP 校验 → UNCONFIRMED，走保守翻译（错误歌曲被本地校验拦截）。
...
**输入要点：** mode=`unconfirmed_full_batch`；无权威歌词，仅携带 9 条原始 cue，禁止编造。
...
| whisper-1-2800 | 2800..7000 | Nobody could, I need to be around you | 没有人能，我需要在你身边 |
| whisper-2-7000 | 7000..10600 | Watching you, no one else can love you | 看着你，没有人能像我这样爱你 |
| whisper-3-10600 | 10600..12600 | Like I do | 像我这样 |
| whisper-4-12600 | 12600..17000 | Healing and I'm creeping up on you | 治愈中，我悄悄靠近你 |
| whisper-5-17000 | 17000..20000 | I know that it won't be right | 我知道那不对 |
| whisper-6-20000 | 20000..25000 | If I stay all night to be among you | 如果我整夜留下，只为在你身边 |
| whisper-7-25000 | 25000..29000 | Creeping my own you | 悄悄靠近属于我的你 |
...
| whisper-1-2800 | Nobody could, I need to be around you | 没有人能，我需要在你身边 |
| whisper-2-7000 | Watching you, no one else can love you | 看着你，没有人能像我这样爱你 |
| whisper-3-10600 | Like I do | 像我这样 |
| whisper-4-12600 | Healing and I'm creeping up on you | 治愈中，我悄悄靠近你 |
| whisper-5-17000 | I know that it won't be right | 我知道那不对 |
| whisper-6-20000 | If I stay all night to be among you | 如果我整夜留下，只为在你身边 |
| whisper-7-25000 | Creeping my own you | 悄悄靠近属于我的你 |
...
| 检索 | 查询 | 命中数 |
|---|---|---|
| 身份检索 | Space Between / Sia | 20 |
| 身份检索 | The Space Between / Dave Matthews Band | 20 |
| 文本兜底检索 | It was like we're all who stands apart There's so much space… | 0 |
| 文本兜底检索 | It was like we're all who stands apart There's so much space… | 0 |

songMatch：`SongMatch(status=UNCONFIRMED, title=Space Between, artist=Sia, confidence=null, source=lyrics-candidate-unverified)`
...
| whisper-2-13000 | 13000..17000 | Baby, we're already behind | 亲爱的，我们已然落后 |
| whisper-3-17000 | 17000..35840 | And you have given me something that I can't live without. | 你给了我无法割舍的东西 |
...
| whisper-2-13000 | Baby, we're already behind | 亲爱的，我们已然落后 |
| whisper-3-17000 | And you have given me something that I can't live without. | 你给了我无法割舍的东西 |
...
| 检索 | 查询 | 命中数 |
|---|---|---|
| 身份检索 | The Last Time / Taylor Swift | 6 |
| 身份检索 | Exile / Taylor Swift | 20 |
| 文本兜底检索 | Take your eyes off of me so I can leave I'm far too ashamed … | 0 |
| 文本兜底检索 | [Music] Take your eyes off of me so I can leave I'm far too … | 0 |

songMatch：`SongMatch(status=UNCONFIRMED, title=The Last Time, artist=Taylor Swift, confidence=null, source=lyrics-candidate-unverified)`
...
| whisper-1-6240 | 6240..14240 | Take your eyes off of me so I can leave | 把你的目光从我身上移开，这样我才能离开 |
| whisper-2-14240 | 14240..23160 | I'm far too ashamed to do it with you watching me | 我太羞愧了，无法在你注视下这样做 |
...
| whisper-1-6240 | Take your eyes off of me so I can leave | 把你的目光从我身上移开，这样我才能离开 |
| whisper-2-14240 | I'm far too ashamed to do it with you watching me | 我太羞愧了，无法在你注视下这样做 |
...
|---|---|---|---|---|---|
| 视频1（5e4c…） | 9 | 2 路检索 | `UNCONFIRMED` | unconfirmed_full_batch | 2 路身份检索 + 1 路文本兜底检索（放宽门控触发） 均未通过 DP 校验 → UNCONFIRMED，走保守翻译（错误歌曲被本地校验拦截）。 |
| 视频2（6101…） | 4 | 2 路检索 | `UNCONFIRMED` | unconfirmed_full_batch | 2 路身份检索 + 1 路文本兜底检索（放宽门控触发） 均未通过 DP 校验 → UNCONFIRMED，走保守翻译（错误歌曲被本地校验拦截）。 |
| 视频3（f176…） | 5 | 2 路检索 | `UNCONFIRMED` | unconfirmed_full_batch | 2 路身份检索 + 1 路文本兜底检索（放宽门控触发） 均未通过 DP 校验 → UNCONFIRMED，走保守翻译（错误歌曲被本地校验拦截）。 |
