...
## V2-IMPORT-002 closure facts (2026-08-01)
...
- Regression matrix: `100` JVM tests, `6` evaluator tests, Lint, normal Debug, Native Debug, and AndroidTest build all passed.
...
- ONNX preparation/inference runs on controlled background dispatchers. Whisper JNI now receives a cancellation token and configures the native abort callback.
