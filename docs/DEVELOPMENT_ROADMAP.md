...
| `V3-AI-CONTRACT-001` | `LIVE_KEY_TEST_AUTHORIZED / IN_PROGRESS` | 在唯一授权真机 `fcf4b0cb / 25098PN5AC / arm64-v8a / API 36` 实现 DeepSeek 最小认证 probe，并验证 App 内手动输入、Keystore 保存、重启、测试连接、same-key rotation、失败替换保留旧 Key 与删除；歌词/逐 cue 链路继续延后 |
